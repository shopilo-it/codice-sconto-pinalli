#!/usr/bin/env python3
"""
Recupero codici sconto Pinalli da shopilo.it
Sursa: https://shopilo.it/negozi/pinalli.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/pinalli.it"
STORE_NAME = "Pinalli"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Pinalli da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-pinalli)"
    }
    try:
